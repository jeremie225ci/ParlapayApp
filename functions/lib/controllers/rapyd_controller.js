...
class RapydController {
    async createWallet(req, res) {
        try {
            ...
            res.status(500).json({
                error: `Error creando wallet: ${error.response ? error.response.status : ''} - ${error.response ? JSON.stringify(error.response.data) : error.message}`
            });
        }
    }
    async getWalletBalance(req, res) {
        try {
            ...
            let eurAccount = accounts.find((acc) => acc.currency === 'EUR');
            ...
            res.status(500).json({
                error: `Error obteniendo balance: ${error.response ? error.response.status : ''} - ${error.response ? JSON.stringify(error.response.data) : error.message}`
            });
        }
    }
    async transferFunds(req, res) {
        try {
            ...
            try {
                ...
                const rapydService = (0, rapyd_init_1.getRapyd)();
                const transferResponse = await rapydService.transferFunds(senderWalletId, receiverWalletId, parseFloat(amount.toString()), currency);
    ...
    async updateUserBalanceAfterTransfer(userId) {
        try {
            const walletRef = db.collection('wallets').doc(userId);
            const walletDoc = await walletRef.get();
            if (!walletDoc.exists)
    ...
    async addFunds(req, res) {
        try {
            ...
            const rapydService = (0, rapyd_init_1.getRapyd)();
            const checkoutResponse = await rapydService.createCheckout(walletId, parseFloat(amount), currency);
            ...
            res.status(500).json({
                error: `Error añadiendo fondos: ${error.response ? error.response.status : ''} - ${error.response ? JSON.stringify(error.response.data) : error.message}`
            });
        }
    }
    async withdrawFunds(req, res) {
        try {
            ...
            const payoutResponse = await rapydService.withdrawFunds(walletId, parseFloat(amount), currency, beneficiaryId);
            ...
            res.status(500).json({
                error: `Error retirando fondos: ${error.response ? error.response.status : ''} - ${error.response ? JSON.stringify(error.response.data) : error.message}`
            });
        }
    }
    ...
    async createBeneficiary(req, res) {
        try {
            ...
            res.status(500).json({
                error: `Error creando beneficiario: ${error.response ? error.response.status : ''} - ${error.response ? JSON.stringify(error.response.data) : error.message}`
            });
        }
    }
    async verifyIdentity(req, res) {
        try {
            ...
            res.status(500).json({
                error: `Error verificando identidad: ${error.response ? error.response.status : ''} - ${error.response ? JSON.stringify(error.response.data) : error.message}`
            });
        }
    }
    async getIdentityStatus(req, res) {
        try {
            ...
            res.status(500).json({
                error: `Error obteniendo estado: ${error.response ? error.response.status : ''} - ${error.response ? JSON.stringify(error.response.data) : error.message}`
            });
        }
    }
}
exports.RapydController = RapydController;
//# sourceMappingURL=rapyd_controller.js.map